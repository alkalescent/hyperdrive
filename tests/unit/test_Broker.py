...
SAMPLE_HOLDINGS = {
    'AAPL': {'name': 'Apple Inc.', 'quantity': '10', 'average_buy_price': '150.00'},
    'AMZN': {'name': 'Amazon.com', 'quantity': '5', 'average_buy_price': '3000.00'},
    'META': {'name': 'Meta Platforms', 'quantity': '20', 'average_buy_price': '200.00'},
...
def mock_robinhood(mock_env_vars):
    ...
    with patch('hyperdrive.Broker.rh') as mock_rh:
        ...
        mock_rh.get_name_by_symbol.side_effect = lambda s: NAME_MAPPING.get(s, 'Unknown')
...
def mock_store():
    ...
    with patch('hyperdrive.Broker.FileReader') as MockReader, \
